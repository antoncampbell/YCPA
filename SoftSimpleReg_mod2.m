...
for ii=1:20
    start=55;
    current=start+ii*2;
    epi{1}(125:150,current:current)= c_eps_0*11.3;
end
...
bc{1}.NumS = 1;
% .s(1): set general program parameters 
...
% .xm .xp .ym .yp: boundary on specific sides
% e: electric field generation
% h: magnetic field generation
% a: absorbtion boundary
